...
f=open('\\\\cdc.gov\\csp_Project\\CIPSEA_DHIS_NHIS\\Production\\NLP_DEV\\development_data\\evaluate.txt','r').readlines()
with open('\\\\cdc.gov\\csp_Project\\CIPSEA_DHIS_NHIS\\Production\\NLP_DEV\\development_data\\evaluate.txt','r') as f:
    lines = f.readlines()
f.close() 
...
file = open("\\\\cdc.gov\\csp_Project\\CIPSEA_DHIS_NHIS\\Production\\NLP_DEV\\development_data\\evaluate.html","w")
file.write(html)
file.close()