'''
script to generate tf-idf of sentence(s) in documents
...
#read text document 
ff = io.open(r'C:\Users\pqn7\OneDrive - CDC\Personal\grad_statement_docs\smu_junked_together.txt', 'r', encoding='utf-8')
doc=ff.read()
ff.close()
doc.replace('\n', '')
