...
class SASCorpusReader(CategorizedCorpusReader, CorpusReader):
...
''' Read corpus '''
_corpus = CIPSEACorpusReader(r"\\cdc.gov\csp_project\CIPSEA_PII_NHIS_EXCHANGE\Census\Testing\PQN7nlp\corpora")
corpus = []
...
#targets=['mailing', 'refuse', 'slowly', 'experience', 'horse', 'may', 'nicely']
#dispersion_plot(tokens_text, targets, ignore_case=True, title='Lexical Dispersion Plot')

#rspndoth
#plt.figure(figsize=(15,8))
#targets=['elderly', 'location', 'care', 'member', 'tonight', 'family', 'nicely']
#dispersion_plot(tokens_text, targets, ignore_case=True, title='Lexical Dispersion Plot')

#rspndoth
#plt.figure(figsize=(15,8))
#targets=['afraid', 'can', 'citizen', 'participate', 'hurry', 'nicely', 'mailing']
#dispersion_plot(tokens_text, targets, ignore_case=True, title='Lexical Dispersion Plot')

#rspndoth
plt.figure(figsize=(15,8))
targets=['shift', 'sleep', 'tonight', 'response', 'also', 'texte', 'right']
dispersion_plot(tokens_text, targets, ignore_case=True, title='Lexical Dispersion Plot')
'''
